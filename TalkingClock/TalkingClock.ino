...
it's : [two]    : [ten]       : am              (h02, m10)
it's : [three]  : [twenty]    : am              (h03, m20)
it's : [four]   : [thirty]    : am              (h04, m30)
it's : [five]   : [forty]     : am              (h05, m40)
it's : [six]    : [fifty]     : am              (h06, m50)
it's : [seven]  : [oh]        : [one]   : am    (h07, m0x, m1)
it's : [eight]  : [twenty]    : [two]   : am    (h08, m2x, m2)
it's : [nine]   : [thirty]    : [three] : am    (h09, m3x, m3)
it's : [ten]    : [forty]     : [four]  : am    (h10, m4x, m4)
it's : [eleven] : [fifty]     : [five]  : am    (h11, m5x, m5)
it's : [twelve] : oh          : [six]   : am    (h12, m6)
it's : one      : twenty      : [seven] : am    (m7)
it's : two      : thirty      : [eight] : am    (m8)
it's : three    : forty       : [nine]  : am    (m9)
it's : four     : [eleven]    : [pm]            (m11, pm)
it's : five     : [twelve]    : pm              (m12)
it's : six      : [thirteen]  : pm              (m13)
it's : seven    : [fourteen]  : pm              (m14)
it's : eight    : [fifteen]   : pm              (m15)
it's : nine     : [sixteen]   : pm              (m16)
it's : ten      : [seventeen] : pm              (m17)
it's : eleven   : [eighteen]  : pm              (m18)
